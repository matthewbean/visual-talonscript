        ...
        >
          ...
          <Grid sx={{ alignItems: "center" }} container spacing={1}>
                ...
                control={
                  <Checkbox
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      editModifier(uuid, e.target.name)
                    }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    checked={modifiers.super}
                  />
                }
                label="Command/Windows"
              />
            </Grid>
            ...
            <Grid xs={2}>
              <HelperButton
                text={
                  "Talon will press a key along with all of the modifiers selected. For example, if you select Shift and a, Talon will press Shift+a."
                }
              />
            </Grid>
            <Grid xs={1}>
