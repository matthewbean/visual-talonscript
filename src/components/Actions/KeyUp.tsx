...
export default function KeyUp({moveUpCommand, uuid, value, current, editAction, moveDownCommand, deleteAction }:Props) {
    ...
    return (
        ...
        {   current?
            ...
            <Grid sx={{alignItems:'center'}} container spacing={1}>
                ...
                <Grid xs={10}>
                    <InputLabel id="demo-simple-select-label">Key Up</InputLabel>
                    <Select
            ...
            (<Box sx={{m:1, ml:2}}>Release: "{value}"</Box>)      
        }
        </>
    )
}
